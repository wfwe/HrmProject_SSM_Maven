...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"该输入项为必填项",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_536,blur:_53a,mouseenter:_53d,mouseleave:_540,click:function(e){
var t=$(e.data.target);
...
message:"请输入{0} 到 {1}位之间的数"},remote:{validator:function(_568,_569){
var data={};
data[_569[1]]=_568;
